...
const Certificates = () => {
  const certs = [
    { title: "Web Design for Beginners", subTitle: "University of Moratuwa (UOM)", result: "Completed" },
    { title: "Front-End Web Development", subTitle: "University of Moratuwa (UOM)", result: "In Progress" },
    { title: "Python for Beginners", subTitle: "University of Moratuwa (UOM)", result: "Completed" },
    { title: "Python Programming", subTitle: "University of Moratuwa (UOM)", result: "In Progress" },
    ...
    { title: "AWS Cloud Practitioner Essentials", subTitle: "Amazon Web Services (AWS)", result: "In Progress" },
